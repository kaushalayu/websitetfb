...
const ShopGrid = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        setPagination(prodRes.pagination || { page: 1, limit: 12, total: 0, pages: 1 })
      } catch (err) {
        if (import.meta.env.DEV) console.error('Failed to fetch shop grid data:', err)
      } finally {
        setLoading(false)
      }
    }
  ...
  const productLink = (slug) => `/product-variable?slug=${slug}`

  const getImage = (product, index = 0) => {
    if (product.images && product.images.length > 0) {
      return getImageUrl(product.images[index]?.url || product.images[0]?.url, 'assets/img/product/product1.webp')
    }
    return 'assets/img/product/product1.webp'
  }
                ...
                <div className="row">
                    ...
                    <div className="col-12">
                        ...
                        <div className="shop__header bg__gray--color d-flex align-items-center justify-content-between mb-30">
                            ...
                            <div className="product__view--mode d-flex align-items-center">
                                ...
                                <div className="product__view--mode__list product__short--by align-items-center d-none d-lg-flex">
                                    ...
                                    <div className="select shop__header--select">
                                        ...
                                        <select className="product__view--select" value={page} onChange={(e) => updateParams({ page: e.target.value })}>
                                ...
                                <div className="product__view--mode__list product__short--by align-items-center d-none d-lg-flex">
                                    ...
                                    <div className="select shop__header--select">
                                        ...
                                        <select className="product__view--select" value={sort || 'latest'} onChange={handleSort}>
                            ...
                            <p className="product__showing--count">Showing {products.length} of {pagination.total} results</p>
                                    ...
                                    <div className="product__section--inner product__grid--inner">
                                        ...
                                        <div className="row row-cols-xl-4 row-cols-lg-3 row-cols-md-3 row-cols-2 mb--n30">
                                          ...
                                          {loading ? (
                                            ...
                                            <div className="col mb-30" key={product._id}>

                                                <div className="product__items ">

                                                    <div className="product__items--thumbnail">

                                                        <Link to={productLink(product.slug)} className="product__items--link" >

                                                            <img className="product__items--img product__primary--img" src={getImage(product, 0)} alt={product.title} />

                                                            <img className="product__items--img product__secondary--img" src={getImage(product, 1) || getImage(product, 0)} alt={product.title} />
                                                        ...
                                                        <div className="product__badge">
                                                            ...
                                                            <span className="product__badge--items sale">{product.salePrice ? 'Sale' : 'New'}</span>
                                                        ...
                                                        <ul className="product__items--action d-flex justify-content-center">
                                                            ...
                                                            <li className="product__items--action__list">
                                                                ...
                                                                <Link to="/wishlist" className="product__items--action__btn" >
                                                            ...
                                                            <li className="product__items--action__list">
                                                                ...
                                                                <Link to="/compare" className="product__items--action__btn" >

                                                                    <svg className="product__items--action__btn--svg" xmlns="http://www.w3.org/2000/svg" width="16.47" height="13.088" viewBox="0 0 15.47 11.088">
                                                    ...
                                                    <div className="product__items--content text-center">
                                                        ...
                                                        <div className="product__items--color">
                                                            ...
                                                            <ul className="product__items--color__wrapper d-flex justify-content-center">
                                                                ...
                                                                <li className="product__items--color__list" key={ci}><a className="product__items--color__link one" href="javascript:void(0)"><span className="visually-hidden">Color {ci + 1}</span></a></li>
                                                                ))}
                                                        ...
                                                        <h3 className="product__items--content__title h4"><Link to={productLink(product.slug)} >{product.title}</Link></h3>

                                                        <div className="product__items--price">

                                                            <span className="current__price">{displayPrice(product)}</span>

                                                            {displayOldPrice(product) && (
                                                            <span className="old__price">{displayOldPrice(product)}</span>
                                                            )}
                                                ...
                                                <div className="product__items product__list--items border-radius-5 d-flex align-items-center">
                                                    ...
                                                    <div className="product__list--items__left d-flex align-items-center">
                                                        ...
                                                        <div className="product__list--items__content">
                                                            ...
                                                            <span className="product__items--content__subtitle mb-5">{product.brand || product.category?.name || 'General'}</span>

                                                            <h4 className="product__list--items__content--title mb-15"><Link to={productLink(product.slug)} >{product.title}</Link></h4>

                                                            <p className="product__list--items__content--desc m-0">{product.description ? (product.description.substring(0, 120) + '...') : 'Lorem, ipsum dolor sit amet consectetur adipisicing elit. Quia voluptas dolore doloribus architecto sequi corporis deleniti officia culpa dolor esse consectetur eligendi.'}</p>
                                                    ...
                                                    <div className="product__list--items__right">
                                                        ...
                                                        <span className="product__list--current__price">{displayPrice(product)}</span>
                                                        ...
                                                        <div className="product__list--action">
                                                            ...
                                                            <ul className="product__list--action__wrapper d-flex align-items-center">
                                                                ...
                                                                <li className="product__list--action__child">
                                                                    ...
                                                                    <a className="product__list--action__btn" data-open="modal1" href="javascript:void(0)">
                                                                ...
                                                                <li className="product__list--action__child">
                                                                    ...
                                                                    <Link to="/wishlist" className="product__list--action__btn" >
                                                                ...
                                                                <li className="product__list--action__child">
                                                                    ...
                                                                    <Link to="/compare" className="product__list--action__btn" >
                                ...
                                <nav className="pagination">
                                    ...
                                    <ul className="pagination__wrapper d-flex align-items-center justify-content-center">
                                        ...
                                        <li className="pagination__list">
                                          {page > 1 ? (
                                            <Link to={`?${new URLSearchParams({ ...Object.fromEntries(searchParams), page: page - 1 }).toString()}`} className="pagination__item--arrow link">
                                            ...
                                            <span className="pagination__item--arrow link">
                                              <svg xmlns="http://www.w3.org/2000/svg" width="22.51" height="20.443" viewBox="0 0 512 512"><path fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="48" d="M244 400L100 256l144-144M120 256h292"/></svg>
                                            </span>
                                          )}
                                        </li>
                                        ...
                                        {Array.from({ length: pagination.pages }, (_, i) => i + 1).map((p) => (
                                          <li className="pagination__list" key={p}>
                                            {p === page ? (
                                              <span className="pagination__item pagination__item--current">{p}</span>
                                            ) : (
                                              <Link to={`?${new URLSearchParams({ ...Object.fromEntries(searchParams), page: p }).toString()}`} className="pagination__item link">{p}</Link>
                                            )}
                                          </li>
                                        ))}
